...
namespace WindowsGSM.Plugins
{
    public class Foundry : SteamCMDAgent
    {
        ...
        public override string StartPath => @"FoundryDedicatedServerLauncher.bat"; // Game server start path
        ...
        public string Port = "30000"; // Default port
        public string QueryPort = "30000"; // Default query port. This is the port specified in the Server Manager in the client UI to establish a server connection.
